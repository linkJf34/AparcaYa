/* ================================================
   REGISTROD.JS — AparcaYA
   Ruta: /js/registroD.js
   ✅ CAMBIO: renombrado de /Script/Registro.js
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        requiredFields.forEach(field => {
            ...
            if (field.id === "correo") {
                customValidator = (value) => {
                    ...
                    if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value)) return { isValid: false, message: "Formato de correo inválido." };
                    return { isValid: true };
                };
    ...
    // Validación de barrio en submit
